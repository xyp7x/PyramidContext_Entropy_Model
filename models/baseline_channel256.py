...
from compressai.models.google import MeanScaleHyperprior, JointAutoregressiveHierarchicalPriors
...
class JointAutoregressiveHierarchicalPriors_Channel256(MeanScaleHyperprior):
...
class Cheng2020Attention_Channel256(Cheng2020Anchor):
